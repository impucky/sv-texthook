- Copies in-game text to the clipboard for usage with Yomitan and a texthook page like [Renji's](https://renji-xd.github.io/texthooker-ui/) or [this one from TMW](https://learnjapanese.moe/texthooker.html)
